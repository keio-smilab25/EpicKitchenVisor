...
test_videos = ["P01_03", "P01_05", "P01_07"]

print(f"Testing with {len(test_videos)} videos: {', '.join(test_videos)}")
print("="*60)

results = []
for video_id in test_videos:
    annotation_file = f"{video_id}.json"
...
print(f"\n✓ Successfully processed {len(results)}/{len(test_videos)} videos")
print("="*60)
